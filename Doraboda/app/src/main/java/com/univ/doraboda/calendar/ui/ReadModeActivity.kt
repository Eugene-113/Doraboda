...
import com.univ.doraboda.calendar.viewmodel.ReadModeViewModel
import com.univ.doraboda.calendar.viewmodel.ReadModeViewModel.ReadModeIntent
...
class ReadModeActivity : AppCompatActivity() {
                    ...
                    "memo" -> {
                        ...
                        when(btnType.toString()){
                            in "delete" -> {
                                ...
                                if(isMemoExist) viewModel.handleIntent(ReadModeIntent.DeleteMemo(nonEditedDate))
                            }
                            in "save" -> {
    ...
    fun setImage(emotion: String?){
        ...
        Glide.with(baseContext).load(image)
            ...
            .into(binding.readModeEditImageView1)
    }
}